...
import (
	...
	"github.com/Junkes887/bootcamp-server/internal/store/pgstore"
		...
		r.Route("/rooms", func(r chi.Router) {
			...
			r.Route("/{room_id}/messages", func(r chi.Router) {
				...
				r.Route("/{message_id}", func(r chi.Router) {
					...
					r.Patch("/react", a.handlerReactRoomMessage)
					r.Delete("/react", a.handlerRemoveReactRoomMessage)
					r.Patch("/answer", a.handlerMarkAnsweredRoomMessage)
				})
			})
		})
	})
...
func (h apiHandler) handlerReactRoomMessage(w http.ResponseWriter, r *http.Request) {

}

func (h apiHandler) handlerRemoveReactRoomMessage(w http.ResponseWriter, r *http.Request) {

}

func (h apiHandler) handlerMarkAnsweredRoomMessage(w http.ResponseWriter, r *http.Request) {
